...
$tpl->define("main","vendor_goods_list.html");
$tpl->scan_area("main");
...
$listPaging->search_variable	= array('field' => 0, 'keyword' => 0, 'cate' => 3, 'date_type' => 5, 's_date' => 5, 'e_date' => 2, 'sort' => 0, 'limit' => 0, 'page' => 0, 'display_use' => 1, 'sale_use' => 1, 'option_use' => 1, 'qty_type' => 1, 'vendor' => 1, 'commission_type' => 1, 'auth_ck' => 1, 'atotal_record' => 0, 'total_record' => 0);
$listPaging->list_variable		= array('uid' => '', 'image3' => '', 'name' => '', 'vendor' => 'vendor_isset', 'cate' => 'cate', 'price' => 'goods_price', 'orig_price' => 'number', 'commission' => 'float', 'commission_type' => 'function', 'consumer_price' => 'number', 'display_use' => 'array', 'sale_use' => 'array', 'auth_ck' => 'array', 'qty_type' => 'function|qty|uid|option_use|name');
$listPaging->default_where = " vendor != ''";
######################## listPaging 정의 #############################
...
$auth_ck_array					= array("N"=>"<i class='fas fa-times colorOrange'></i>","Y"=>"<i class='far fa-circle'></i>"); 
######################## list_variable : array일 경우 정의 #############################
...
$qty_type_function = function ($vls, $qty, $uid, $option_use, $gname) {	
	...
	if($option_use==1) {
		...
		$return = "<span class='optionView underLine size09' data-uid='{$uid}' gname='{$gname}' title='{$gname} 옵션보기'>옵션</span><br />";
...
if($vendor_commission) $vendor_commission = join(",",$vendor_commission);
