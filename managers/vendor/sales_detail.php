...
$tpl->define("main","sales_detail.html");
$tpl->scan_area("main");
...
$listPaging->list_variable		= array('uid' => 'function|status', 'order_num' => '', 'vendor' => 'vendor', 'title' => '', 'price' => 'number', 'commission' => 'number', 'type' => 'array', 'status' => 'array', 'signdate' => 'datetime');
$listPaging->default_where		= "vendor != '' && type < 2";
######################## listPaging 정의 #############################
