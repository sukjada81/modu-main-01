...
$listPaging->search_variable	= array('field' => 0, 'keyword' => 0, 'date_type' => 5, 's_date' => 5, 'e_date' => 2, 'vendor' => 1, 'type' => 1, 'status' => 1, 'sort' => 0, 'limit' => 0, 'page' => 0, 'atotal_record' => 0, 'total_record' => 0);
$listPaging->list_variable		= array('uid' => 'function|status', 'order_num' => '', 'vendor' => 'vendor', 'title' => '', 'price' => 'number', 'commission' => 'number', 'cal_price' => 'function|price|commission', 'type' => 'array', 'status' => 'array', 'confirm_date' => 'datetime');
$listPaging->default_where		= "vendor != '' && type < 2 && confirmation = 1";
######################## listPaging 정의 #############################
