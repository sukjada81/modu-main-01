...
$listPaging->search_variable	= array('field' => 0, 'keyword' => 0, 'date_type' => 5, 's_date' => 5, 'e_date' => 2, 'field2' => 0, 'keyword2' => 0, 'field3' => 0, 'keyword3' => 0, 'field4' => 0, 'keyword4' => 0, 'vendor' => 1, 'pay_type' => 2, 'pay_status' => 2, 'mobile' => 2, 'sort' => 0, 'limit' => 0, 'page' => 0, 'atotal_record' => 0, 'total_record' => 0);
$listPaging->list_variable		= array('uid' => '', 'order_num' => 'function|name|id', 'vendor' => 'vendor_isset', 'g_image' => 'function|g_uid', 'g_name' => '', 'option_name' => 'function', 'qty' => 'number', 'price' => 'function|qty|delivery_type|delivery_type_qty|delivery_price|delivery_add_price|option|g_uid|order_num', 'delivery_info' => 'function|status|status_date', 'status' => 'function|status2', 'status_date' => 'datetime2', 'pay_type' => 'array', 'pay_status' => 'array', 'g_uid' => '', 'signdate' => 'datetime');
$listPaging->field_where		= array('id', 'name', 'cell', 'email', 'name2', 'cell2', 'bank_info');
if(strlen($status)) $listPaging->default_where = "reals = 1 && status = '{$status}'";
######################## listPaging 정의 #############################
