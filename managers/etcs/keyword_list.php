...
$tpl->define("main","keyword_list.html");
$tpl->scan_area("main");
...
######################## listPaging 정의 #############################
$listPaging						= new listPaging('mallRN_keyword_recent2'); 
...
$listPaging->list_variable		= array('uid' => '', 'keyword' => '', 'ip' => 'function|id', 'signdate'=>'datetime');
######################## listPaging 정의 #############################
