...
$listPaging->list_variable		= array('uid' => '', 'image3' => 'function|moddate', 'name' => '', 'vendor' => 'vendor_isset', 'cate' => 'cate', 'price' => 'goods_price', 'orig_price' => 'number', 'commission' => 'float', 'commission_type' => '', 'consumer_price' => 'number', 'display_use' => 'array', 'sale_use' => 'array', 'qty_type' => 'function|qty|uid|option_use|name');
######################## listPaging 정의 #############################
