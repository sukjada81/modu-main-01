...
$returnURL			= $HeaderProtocol . $_SERVER["HTTP_HOST"]."/plugin/nicepay/payResult.php"; // 결과페이지(절대경로) - 모바일 결제창 전용
...
<form name="payForm" method="post" action="plugin/nicepay/payResult.php">
