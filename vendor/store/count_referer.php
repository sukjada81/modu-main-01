...
$tpl->define("main","count_referer.html");
$tpl->scan_area("main");
...
######################## listPaging 정의 #############################
$listPaging						= new listPaging('mallRN_store_count_referer'); 
...
$listPaging->list_variable		= array('uid' => '', 'referer' => '', 'os' => '', 'browser' => '', 'check_ip' => '', 'signdate'=>'datetime');
$listPaging->default_where		= "vendor = '{$v_my_id}'";
######################## listPaging 정의 #############################

######################## list_variable : array일 경우 정의 #############################
$multi_array	= array("referer", "check_ip");
######################## list_variable : array일 경우 정의 #############################
