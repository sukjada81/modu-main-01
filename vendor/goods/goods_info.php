...
if($mode=='modify') {
	...
	${"checked_store_display1_".$store_display1}	= "checked='checked'";
	${"checked_store_display2_".$store_display2}	= "checked='checked'";
	${"checked_store_display3_".$store_display3}	= "checked='checked'";
	...
	$checked_engine_use_1		= "checked='checked'";
...
$sql = "SELECT goods_price_limit1, goods_price_limit2, goods_require_info, goods_icon_info FROM mallRN_configuration WHERE uid = 1";
...
$sql = "SELECT goods_option_info, goods_brand_info, goods_make_info, goods_origin_info, delivery_type, delivery_d_price, delivery_p_type, delivery_p_price1, delivery_p_price2, delivery_im_areas1_used, delivery_im_areas1_price, delivery_im_areas2_used, delivery_im_areas2_price FROM mallRN_vendor_configuration WHERE vendor = '{$v_my_id}'";
$multi_data = $mysql->one_row($sql);
