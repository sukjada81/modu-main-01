...
switch($mode) {
	...
	case "delivery" :
		$sql = "SELECT delivery_type, delivery_d_price, delivery_p_type, delivery_p_price1, delivery_p_price2, delivery_im_areas1_used, delivery_im_areas1_price, delivery_im_areas2_used, delivery_im_areas2_price FROM mallRN_vendor_configuration WHERE vendor = '{$v_my_id}'";
