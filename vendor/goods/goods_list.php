...
$field_title_arr = array('no' => '번호', 'uid' => '상품번호', 'image' => '이미지 <i class="xi-external-link"></i>', 'name' => '상품명 <i class="xi-link"></i> / 대표분류 <i class="xi-link"></i>', 'vendor' => '판매사', 'price' => '판매가', 'orig_price' => '공급가', 'commission' => '수수료율', 'consumer_price' => '소비자가', 'display_use' => '진열상태', 'sale_use' => '판매상태', 'qty' => '재고', 'option_use' => '옵션 <i class="xi-link"></i>', 'mileage_type' => '마일리지', 'delivery_type' => '배송비', 'goods_code' => '자체상품코드', 'signdate' => '등록일/수정일');
$field_width_arr = array('no' => '80', 'uid' => '80', 'image' => '100', 'name' => '420', 'vendor' => '120', 'price' => '110', 'orig_price' => '110', 'commission' => '120', 'consumer_price' => '110', 'display_use' => '80', 'sale_use' => '80', 'qty' => '80', 'option_use' => '100', 'mileage_type' => '120', 'delivery_type' => '120', 'goods_code' => '120', 'signdate' => '120');

$sql		= "SELECT fields FROM mallRN_list_show_config WHERE vendor = '{$v_my_id}' && name='goods'";
...
$GLOBALS['DISPLAYS'] = "";
$store_display1_function = function ($vls, $vls2, $vls3) {
	global $tpl;

	$return	= array();
	if($vls) $return[] = "<div class='barTitle1'>스토어</div><div class='barName'>인기</div>";
	if($vls2) $return[] = "<div class='barTitle1'>스토어</div><div class='barName'>추천</div>";
	if($vls3) $return[] = "<div class='barTitle1'>스토어</div><div class='barName'>신</div>";
