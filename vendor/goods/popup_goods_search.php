...
$listPaging->search_variable	= array('field' => 0, 'keyword' => 0, 'cate' => 2, 'date_type' => 5, 's_date' => 5, 'e_date' => 2, 'field2' => 0, 'keyword2' => 0, 'field3' => 0, 'keyword3' => 0, 'field4' => 0, 'keyword4' => 0, 'sort' => 0, 'limit' => 0, 'page' => 0, 'display_use' => 1, 'sale_use' => 1, 'option_use' => 1, 'delivery_type' => 1, 'commission_type' => 1, 'qty_type' => 1, 'limit_qty' => 2, 'cate_hide' => 1, 'soldout' => 2, 'option_soldout' => 1, 'commission_type' => 1, 'information_use' => 1, 'type' => 6, 'type2' => 6, 'type3' => 6, 'search_cate' => 6, 'atotal_record' => 0, 'total_record' => 0);
...
$ck_search_open2 = 0;
if($type == 'display' && $type3) {
	if(!$listPaging->where) $ck_search_open2 = 1;
	$listPaging->default_where = " vendor = '{$v_my_id}' && store_display{$type3} = '0'";
	$listPaging->where = $listPaging->where." && a.store_display{$type3} = '0'";
}
...
if($type == 'relatedGoods' || $type == 'display') {
	$multi = 1;
	$disabled = "";
}
else {
