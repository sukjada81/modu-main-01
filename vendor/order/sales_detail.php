...
$listPaging->list_variable		= array('uid' => 'function|status', 'order_num' => '', 'title' => '', 'price' => 'number', 'commission' => 'number', 'cal_price' => 'function|price|commission', 'type' => 'array', 'status' => 'array', 'signdate' => 'datetime');
$listPaging->default_where		= "vendor = '{$v_my_id}' && type < 2";
######################## listPaging 정의 #############################
